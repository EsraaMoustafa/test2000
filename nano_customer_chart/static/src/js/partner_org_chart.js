odoo.define('nano_custom_chart.partner_org_chart_button', function(require) {
    "use strict";
    ...
    var OrgChartButton = form_widget.WidgetButton.include({
        ...
        on_click: function() {
            ...
            if (self.peopleElement && self.$el.hasClass('org-chart')) {
                ...
                self.partner_id = self.peopleElement.getAttribute('partner');
                self.getDatas();
            }
        },
        ...
        renderOrgChart: function(data) {
            ...
            var orgChart = new getOrgChart(this.peopleElement, {
                primaryFields: ["name", "phone", "mobile", "email"],
                photoFields: ["image"],
        ...
        getDatas: function() {
            return $.ajax({
                url: '/res_partner/get_org_chart/' + this.partner_id,
                method: 'GET',
                data: {},
